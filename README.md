Desktop application on Qt for clinic work, with patient and doctor mode for creating appointments, etc. There was used three-layered architecture and connect to MySql database.
